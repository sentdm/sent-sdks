...
type SMSApiGetContactInfoRequest struct {
	ctx context.Context
...
func (r *SMSApiGetContactInfoRequest) SentId(sentId string) *SMSApiGetContactInfoRequest {
	r.sentId = &sentId
	return r
}

func (r SMSApiGetContactInfoRequest) Execute() (*SMSPayload, *http.Response, error) {
	return r.ApiService.GetContactInfoExecute(r)
}

/*
GetContactInfo Retrieve SMS contact information and capabilities
...
Fetches or creates SMS contact information for a given phone number. This endpoint validates the phone number, determines SMS capabilities, and returns detailed formatting information needed for message delivery. Use this before sending messages to ensure proper SMS channel availability.
 ...
 @return SMSApiGetContactInfoRequest
*/
func (a *SMSApiService) GetContactInfo(phoneNumber string, retrieveIfDoesNotExists bool) SMSApiGetContactInfoRequest {
	return SMSApiGetContactInfoRequest{
		ApiService: a,
...
//  @return SMSPayload
func (a *SMSApiService) GetContactInfoExecute(r SMSApiGetContactInfoRequest) (*SMSPayload, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SMSPayload
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SMSApiService.GetContactInfo")
	if err != nil {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v SmsGetContactInfoResponse
