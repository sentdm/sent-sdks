...
#import "SBasicAuthTokenProvider.h"
#import "SLogger.h"

@interface SDefaultConfiguration ()
...
@implementation SDefaultConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static SDefaultConfiguration *shardConfig = nil;
...
- (NSString *) getBasicAuthToken {
    ...
    NSString *basicAuthToken = [SBasicAuthTokenProvider createBasicAuthTokenWithUsername:self.username password:self.password];
