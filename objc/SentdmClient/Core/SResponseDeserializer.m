...
NSString *const SDeserializationErrorDomainKey = @"SDeserializationErrorDomainKey";

NSInteger const STypeMismatchErrorCode = 143553;

NSInteger const SEmptyValueOccurredErrorCode = 143509;

NSInteger const SUnknownResponseObjectErrorCode = 143528;


@interface SResponseDeserializer ()
...
@implementation SResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:SDeserializationErrorDomainKey code:STypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:SDeserializationErrorDomainKey code:SEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:SDeserializationErrorDomainKey code:SUnknownResponseObjectErrorCode userInfo:userInfo];
}
