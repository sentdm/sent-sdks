  ...
  class Contact
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Sentdm::Contact` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Sentdm::Contact`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'available_channels')
        self.available_channels = attributes[:'available_channels']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          available_channels == o.available_channels &&
    ...
    def hash
      [id, phone_number, country_code, national_format, available_channels, default_channel, verified, created_at, updated_at].hash
    end
