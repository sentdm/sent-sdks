...
public class WhatsAppPayloadAllOf {
 ...
 public enum NumberTypeEnum {
  ...
  public WhatsAppPayloadAllOf() {
  }

  public WhatsAppPayloadAllOf whatsappId(String whatsappId) {
  ...
  **/
  ...
  public WhatsAppPayloadAllOf countryCode(String countryCode) {
  ...
  **/
  ...
  public WhatsAppPayloadAllOf numberType(NumberTypeEnum numberType) {
  ...
  **/
  ...
  public WhatsAppPayloadAllOf profilePicture(String profilePicture) {
  ...
  **/
  ...
  public WhatsAppPayloadAllOf isBusiness(Boolean isBusiness) {
  ...
  **/
  ...
  public WhatsAppPayloadAllOf invalidRecord(Boolean invalidRecord) {
  ...
  **/
   ...
   * @return the WhatsAppPayloadAllOf instance itself
   */
  public WhatsAppPayloadAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WhatsAppPayloadAllOf whatsAppPayloadAllOf = (WhatsAppPayloadAllOf) o;
    return Objects.equals(this.whatsappId, whatsAppPayloadAllOf.whatsappId) &&
        Objects.equals(this.countryCode, whatsAppPayloadAllOf.countryCode) &&
        Objects.equals(this.numberType, whatsAppPayloadAllOf.numberType) &&
        Objects.equals(this.profilePicture, whatsAppPayloadAllOf.profilePicture) &&
        Objects.equals(this.isBusiness, whatsAppPayloadAllOf.isBusiness) &&
        Objects.equals(this.invalidRecord, whatsAppPayloadAllOf.invalidRecord)&&
        Objects.equals(this.additionalProperties, whatsAppPayloadAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(whatsappId, countryCode, numberType, profilePicture, isBusiness, invalidRecord, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WhatsAppPayloadAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WhatsAppPayloadAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WhatsAppPayloadAllOf is not found in the empty JSON string", WhatsAppPayloadAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WhatsAppPayloadAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WhatsAppPayloadAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WhatsAppPayloadAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WhatsAppPayloadAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<WhatsAppPayloadAllOf>() {
           @Override
           public void write(JsonWriter out, WhatsAppPayloadAllOf value) throws IOException {
           ...
           @Override
           public WhatsAppPayloadAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WhatsAppPayloadAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WhatsAppPayloadAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WhatsAppPayloadAllOf
  * @throws IOException if the JSON string is invalid with respect to WhatsAppPayloadAllOf
  */
  public static WhatsAppPayloadAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WhatsAppPayloadAllOf.class);
  }

 /**
  * Convert an instance of WhatsAppPayloadAllOf to an JSON string
  *
  * @return JSON string
  */
