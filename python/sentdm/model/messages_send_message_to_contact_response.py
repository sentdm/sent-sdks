...
class MessagesSendMessageToContactResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["messageId", "status", "channel", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["messageId", "status", "channel", ], str]):
