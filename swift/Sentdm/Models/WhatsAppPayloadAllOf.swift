...
public struct WhatsAppPayloadAllOf: Codable, JSONEncodable, Hashable {
    ...
    public init(whatsappId: String? = nil, countryCode: String? = nil, numberType: NumberType? = nil, profilePicture: String? = nil, isBusiness: Bool? = nil, invalidRecord: Bool? = nil) {
